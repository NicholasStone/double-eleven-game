namespace NumberSettings {
   ...
   * buff 数值设定
   */
  export const LessGravityDiff = GravityY * 0.2
  export const MoreGravityDiff = GravityY * -0.2
  export const LessUpperVelocity = Height * 0.1
  export const MoreUpperVelocity = Height * -0.1
}
